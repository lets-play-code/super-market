...
public class ReceiptTest {
    ...
    public void test_receipt_formatting_with_one_item() {
        Receipt receipt = new Receipt(Collections.singletonList(new ReceiptItem("pizza", 1, 15.00)));
        String[] expected = new String[]{
                "****** SuperMarket receipt ******",
    ...
    public void test_receipt_formatting_with_two_of_the_same_items() {
        Receipt receipt = new Receipt(Collections.singletonList(new ReceiptItem("pizza", 2, 15.00)));
        String[] expected = new String[]{
                "****** SuperMarket receipt ******",
    ...
    public void test_receipt_formatting_with_two_of_the_different_items() {
        Receipt receipt = new Receipt(List.of(new ReceiptItem("pizza", 2, 15.00), new ReceiptItem("coffee", 1, 10.00)));
        String[] expected = new String[]{
                "****** SuperMarket receipt ******",
                "pizza: 2 x 15.00 --- 30.00",
